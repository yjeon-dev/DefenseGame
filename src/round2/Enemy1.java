...
public class Enemy1 extends Thread {
	...
	Enemy1(JLabel ene,Object obj) {
		...
		img1 = new ImageIcon("src/mon2/monm1.png");
		img2 = new ImageIcon("src/mon2/monm2.png");
		imga1 = new ImageIcon("src/mon2/mona1.png");
		imga2 = new ImageIcon("src/mon2/mona2.png");
		hp = 50;
		atk = 100;
		move = 7;
		atks = 100;
