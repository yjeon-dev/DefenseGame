...
public class Enemy1 extends Thread {
	...
	Enemy1(JLabel ene,Object obj) {
		...
		img1 = new ImageIcon("src/mon1/monm1.png");
		img2 = new ImageIcon("src/mon1/monm2.png");
		imga1 = new ImageIcon("src/mon1/mona1.png");
		imga2 = new ImageIcon("src/mon1/mona2.png");
		hp = 15;
		atk = 10;
		move = 5;
		atks = 100;
