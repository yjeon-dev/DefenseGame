...
public class Enemy1 extends Thread {
	...
	Enemy1(JLabel ene,Object obj) {
		...
		img1 = new ImageIcon("src/mon5/monm1.png");
		img2 = new ImageIcon("src/mon5/monm2.png");
		imga1 = new ImageIcon("src/mon5/mona1.png");
		imga2 = new ImageIcon("src/mon5/mona2.png");
		hp = 2500;
		atk = 1000;
		move = 20;
		atks = 100;
