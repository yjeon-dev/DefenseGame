...
public class Enemy1 extends Thread {
	...
	Enemy1(JLabel ene,Object obj) {
		...
		img1 = new ImageIcon("src/mon3/monm1.png");
		img2 = new ImageIcon("src/mon3/monm2.png");
		imga1 = new ImageIcon("src/mon3/mona1.png");
		imga2 = new ImageIcon("src/mon3/mona2.png");
		hp = 150;
		atk = 60;
		move = 10;
		atks = 100;
